...
import { ECSClusterProps, EcsEc2NginxAsgSetting, EcsServiceResult, getEc2UserData } from "./ecs";
...
export function crateEC2LuaService(
  scope: Construct,
  props: ECSClusterProps,
  cluster: ecs.Cluster,
  ecsAsgSetting: EcsEc2NginxAsgSetting,
  nginxLuaImage: ecs.ContainerImage,
  ...
  const nginxContainer = taskDefinition.addContainer("nginx-lua", {
    image: nginxLuaImage,
